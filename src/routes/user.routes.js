...
const { getAllUsers, getAllUserInternal, getAllUserDRM, getUserById, createUser, updateUser, deleteUser } = require('../controllers/user.controller');
...
router.get('/userInternal', authenticateToken, authorizeRoles([2, 3, 4]), getAllUserInternal);
router.get('/userDRM', authenticateToken, authorizeRoles([2, 3, 4]), getAllUserDRM);
